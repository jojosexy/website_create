...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const animateElements = document.querySelectorAll('.section-title, .section-subtitle, .about-text, .about-card, .skill-category, .contact-item, .contact-form');
...
// Add active link styles to CSS dynamically
...
document.addEventListener('DOMContentLoaded', () => {
    const cards = document.querySelectorAll('.skill-category, .about-card, .profile-card');
    
    cards.forEach(card => {
        card.addEventListener('mouseenter', () => {
            card.style.transform = card.classList.contains('profile-card') 
